    ...
    <div className="flex flex-col items-center justify-center py-10 sm:py-16 min-h-full rounded-xl">
      <div className="bg-zinc-900 p-6 sm:p-8 rounded-2xl shadow-[0_0_20px_rgba(168,85,247,0.3)] border border-purple-500/50 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="p-4 bg-zinc-950/60 border border-purple-500/20 rounded-xl text-xs text-gray-400 space-y-1.5 select-none">
            ...
            <ul className="list-disc pl-4 space-y-1">
              <li>
                Minimo{" "}
                <span className="text-gray-200 font-semibold">8 caratteri</span>{" "}
                di lunghezza
              </li>
              <li>
                Almeno una lettera{" "}
                <span className="text-gray-200 font-semibold">maiuscola</span>
              </li>
              <li>
                Almeno un{" "}
                <span className="text-gray-200 font-semibold">numero</span>
              </li>
              <li>
                Almeno un{" "}
                ...
                consentito:
                <code className="text-purple-400 bg-zinc-900/80 px-1.5 py-0.5 rounded border border-purple-500/10 ml-1 font-mono tracking-wider">
                  ! @ # $ % ^ & * _ ? + -
                </code>
              </li>
            </ul>
        ...
        <p className="text-center text-sm text-gray-400 mt-8">
          ...
          <Link
            to="/login"
            className="text-purple-400 font-bold hover:text-purple-300 hover:drop-shadow-[0_0_5px_rgba(168,85,247,0.8)] transition-all"
          >
