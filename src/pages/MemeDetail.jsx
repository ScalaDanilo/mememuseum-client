...
import { User, Send, ArrowLeft, MessageSquare, Heart, HeartCrack, X } from 'lucide-react';
...
const MemeDetail = () => {
  ...
  const handleAddComment = async (e) => {
    ...
    try {
      ...
      alert(error.response?.data?.error || "Errore durante la pubblicazione.");
    } finally {
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="flex flex-col gap-4 lg:sticky lg:top-24">
            ...
            <div className="bg-zinc-900/50 rounded-2xl border border-purple-500/20 overflow-hidden shadow-[0_0_30px_rgba(168,85,247,0.1)]">
